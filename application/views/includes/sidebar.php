...
document.addEventListener("DOMContentLoaded",function() {
   let route = '';
   route = localStorage.getItem('route_selected')||'main_ajax'
   loadModule(route)
   if(route=='reports_ajax'){
		...
		if(start_date!==''&&end_date!==''&&report_type){
			...
			$("#start_date_datepicker").val(start_date)
			$("#end_date_datepicker").val(end_date) 
			load_reports(data='')
			console.log(report_type)
			console.log(start_date)
			console.log(end_date)
			console.log(name)
			loadReportHtml(report_type, start_date, end_date, name)
		}
	}
});
